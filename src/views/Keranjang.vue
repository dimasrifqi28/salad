          ...
          <form class="mt-4" v-on:submit.prevent>
            ...
            <div class="form-grou">
              ...
              <textarea
                ...
                class="form-control"
                placeholder="Keterangan spt : Tidak Pakai Keju, Tidak Pakai Susu .."
              >
              </textarea>
            </div>
            <br />
...
export default {
  ...
  methods: {
    ...
    checkout() {
      if (this.pesan.nama && this.pesan.keterangan) {
        ...
        axios
          ...
          .then(() => {
            ...
            this.$toast.success("Suskses di Pesan", {
              type: "success",
              position: "top-right",
              duration: 3000,
              dismissible: true,
        ...
        this.$toast.error("Nama dan Keterangan Harus di Isi", {
          type: "error",
          position: "top-right",
          duration: 3000,
          dismissible: true,
